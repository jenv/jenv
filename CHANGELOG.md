...
- Merge pull request [#438](https://github.com/jenv/jenv/issues/438) from [findepi](https://github.com/findepi)/findepi/add-jenv-with-command-to-pick-version-for-single-command-188119
- Merge pull request [#452](https://github.com/jenv/jenv/issues/452) from [gouvinb](https://github.com/gouvinb)/master
- Merge pull request [#454](https://github.com/jenv/jenv/issues/454) from [OothecaPickle](https://github.com/OothecaPickle)/patch-1
- Merge pull request [#457](https://github.com/jenv/jenv/issues/457) from [findepi](https://github.com/findepi)/findepi/cleanup-jenv-javahome-1626b4
- Merge pull request [#458](https://github.com/jenv/jenv/issues/458) from [andrewflbarnes](https://github.com/andrewflbarnes)/bugfix/remove-skip-existing
- Merge pull request [#459](https://github.com/jenv/jenv/issues/459) from [andrewflbarnes](https://github.com/andrewflbarnes)/feature/bellsoft-provider
- Merge pull request [#460](https://github.com/jenv/jenv/issues/460) from [andrewflbarnes](https://github.com/andrewflbarnes)/bugfix/graalvm-provider
- Merge pull request [#461](https://github.com/jenv/jenv/issues/461) from [andrewflbarnes](https://github.com/andrewflbarnes)/bugfix/always-64bit
- Merge pull request [#462](https://github.com/jenv/jenv/issues/462) from [andrewflbarnes](https://github.com/andrewflbarnes)/bugfix/versionless-shim-exec
- Merge pull request [#52](https://github.com/jenv/jenv/issues/52) from [roryokane](https://github.com/roryokane)/patch-2

### Features

- Support bellsoft/liberica versions

### Bug Fixes

- Allow a --force option on rehash to remove .jenv-shim
- Correctly detect 32/64 bit
- Don't use versioned shim exec paths
- Ensure graalvm detecteda before hotspot
- Prevent noclobber issues on /dev/null
- Remove old skip existing flag from add completion
...
- Jenv.be available again, add back to readme
- Remove deprecation notice on custom alias
